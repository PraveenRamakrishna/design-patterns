...
Possible Usage Scenarios
	...
	- Remote Proxy, a local representation of remote object
	- Virtual Proxy, a skeleton representation of complex or heavy object.
	- Protection Proxy, used to control access to a resource based on access right.